...
parser.add_argument('-eva', '-evaluation', default='f1',
...
##############以上新增###########################
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        # writer2.add_scalar('training accuracy',acc5[0], epoch * len(train_loader) + i)
        # writer2.flush()
...
if __name__ == '__main__':
    # writer1 = SummaryWriter('runs/tiny_imagenet_resnet')
    # writer2 = SummaryWriter('runs/tiny_imagenet_resnet')
    # writer3 = SummaryWriter('runs/tiny_imagenet_resnet')
    # writer4 = SummaryWriter('runs/tiny_imagenet_resnet')
    main()